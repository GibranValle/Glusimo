...
public class BluetoothManager {
    ...
    public static final int STATE_DISCONNECTING = 4;  // now intenting to stop BT
    public static final int STATE_DISCONNECTED = 5;  // now disconnected
    // Debugging
    ...
    private static final String NAME_MC = "ConectarMicroControlador";
    // Unique UUID for this application
    //private static final UUID MY_UUID_SECURE = UUID.fromString("fa87c0d0-afac-11de-8a39-0800200c9a66"); ORIGINAL
    private static final UUID MY_UUID_INSECURE = UUID.fromString("8ce255c0-200a-11e0-ac64-0800200c9a66");
    private static final UUID MY_UUID_SECURE = UUID.fromString("00001101-0000-1000-8000-00805F9B34FB"); //USAR LA SECURE COMO DEFAULT PARA DEVICE
    // Member fields
    private final BluetoothAdapter mAdapter;
    private final Handler mHandler;
    /**
     * Esta clase detecta cuando se pierde la conexion
     */
    ...
    private synchronized void setState(int state) {
        ...
        mHandler.obtainMessage(Interfaz.MESSAGE_STATE_CHANGE, state, -1).sendToTarget();
    }
    ...
    public synchronized void connected(BluetoothSocket socket, BluetoothDevice
        ...
        Message msg = mHandler.obtainMessage(Interfaz.MESSAGE_DEVICE_NAME);
        Bundle bundle = new Bundle();
        bundle.putString(Interfaz.DEVICE_NAME, device.getName());
        msg.setData(bundle);
     ...
     * @seeelectronica.upibi.gibran.controlbrazo.BluetoothManager.ConnectedThread#write(byte[])
     */
        ...
        */
        ...
        public void write(byte[] buffer) {
            try {
                ...
                mHandler.obtainMessage(Interfaz.MESSAGE_WRITE, -1, -1, buffer)
                        .sendToTarget();
            } catch (IOException e) {

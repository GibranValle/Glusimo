...
public class DeviceList extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button boton_buscar_conectar = (Button) findViewById(R.id.b_buscar);
        boton_buscar_conectar.setOnClickListener(new View.OnClickListener() {
        ...
        if (pairedDevices.size() > 0) {
            boton_buscar_conectar.setText(R.string.conectar);
            ...
            boton_buscar_conectar.setText(R.string.buscar);
